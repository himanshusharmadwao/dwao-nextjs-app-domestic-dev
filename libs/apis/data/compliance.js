...
export const getCompliance = async (preview = false) => {
  try {
    let url = `${process.env.NEXT_PUBLIC_API_BASE_URL}/compliances?` +
      ...
      `&populate[5]=compliances&populate[6]=compliances.image` +
